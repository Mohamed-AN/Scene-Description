...
def update_output(content_browse, content_drag_drop, c1, c2, c3, c4, c5, c6, c7, c8, c9, c_url, s1, s2, s3, s4, s5, s6,
                  s7, s8, s9, s_url):
    ...
    if triggered_id == 'upload-image':
        ...
        return pass_img_to_model(content_browse, image)
        ...
        image = Image.open(BytesIO(base64.b64decode(image_base64[base64_code_start_idx:])))
        return pass_img_to_model(content_drag_drop, image)
